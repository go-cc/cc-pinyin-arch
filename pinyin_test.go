...
func nnTestUpdated(t *testing.T) {
	...
	testData := []testItem{
		...
		{"呀", NewPinyin(Normal, Finals, Separator, false, false), "ia"},
		...
		{"无", NewPinyin(Normal, Finals, Separator, false, false), "u"},
		{"衣", NewPinyin(Tone2, Normal, Separator, false, false), "yi1"},
		{"衣", NewPinyin(Tone1, Normal, Separator, false, false), "yi1"},
		{"衣", NewPinyin(Normal, Finals, Separator, false, false), "i"},
		{"万", NewPinyin(Tone2, Normal, Separator, false, false), "wa4n"},
		{"万", NewPinyin(Tone1, Normal, Separator, false, false), "wan4"},
		{"万", NewPinyin(Normal, Finals, Separator, false, false), "uan"},
		// ju, qu, xu 的韵母应该是 v
		{"具", NewPinyin(Tone3, Finals, Separator, false, false), "ǜ"},
		{"具", NewPinyin(Tone2, Finals, Separator, false, false), "v4"},
		{"具", NewPinyin(Tone1, Finals, Separator, false, false), "v4"},
		{"具", NewPinyin(Normal, Finals, Separator, false, false), "v"},
		{"取", NewPinyin(Tone3, Finals, Separator, false, false), "ǚ"},
		{"取", NewPinyin(Tone2, Finals, Separator, false, false), "v3"},
		{"取", NewPinyin(Tone1, Finals, Separator, false, false), "v3"},
		{"取", NewPinyin(Normal, Finals, Separator, false, false), "v"},
		{"徐", NewPinyin(Tone3, Finals, Separator, false, false), "ǘ"},
		{"徐", NewPinyin(Tone2, Finals, Separator, false, false), "v2"},
		{"徐", NewPinyin(Tone1, Finals, Separator, false, false), "v2"},
		{"徐", NewPinyin(Normal, Finals, Separator, false, false), "v"},
		// # ń
		...
		{"嗯", NewPinyin(Normal, Finals, Separator, false, false), "n"},
		{"嗯", NewPinyin(Tone3, Finals, Separator, false, false), "ń"},
		{"嗯", NewPinyin(Tone2, Finals, Separator, false, false), "n2"},
		{"嗯", NewPinyin(Tone1, Finals, Separator, false, false), "n2"},
		// # ḿ  \u1e3f  U+1E3F
		...
		{"呣", NewPinyin(Normal, Finals, Separator, false, false), "m"},
		{"呣", NewPinyin(Tone3, Finals, Separator, false, false), "ḿ"},
		{"呣", NewPinyin(Tone2, Finals, Separator, false, false), "m2"},
		{"呣", NewPinyin(Tone1, Finals, Separator, false, false), "m2"},
		// 去除 0
		...
		{"侵略", NewPinyin(Tone2, Finals, Separator, false, false), "i1n ve4"},
		{"侵略", NewPinyin(Tone1, Finals, Separator, false, false), "in1 ve4"},
	}
